...
export function HermesGatewayConfigFields({
  ...
  return configFieldsForSection(section, (
    <>
      <Field
        label={tf("auto.a45474ea09c37caa")}
      ...
      <SecretField
        ...
        placeholder={tf("auto.3d65035f61523725")}
        stored={!isCreate && hasStoredApiKey && !editApiKeyValue}
      />

      <Field
        label={tf("auto.d7168750e56948f5")}
      ...
      <Field configSection="runPolicy"
        label={tf("auto.1abcf8b114ae46ac")}
      ...
      >
        <select
          ...
          className={inputClass}
        >
          <option value="issue">{tf("auto.837400b846a7f231")}</option>
          <option value="agent">{tf("auto.e098d60a50838206")}</option>
          <option value="run">{tf("auto.fdedd5acd9bcf1b5")}</option>
          <option value="none">{tf("text.None")}</option>
        </select>
      </Field>

      <Field configSection="runPolicy" label={tf("auto.e7a1bb3cdbf4b73c")}>
        <DraftNumberInput
      ...
      <Field
        label={tf("auto.4e117b415c810ed6")}
      ...
      <ToggleField
        label={tf("auto.876d0d77f7c9ad73")}
      ...
      <Field
        label={tf("auto.e53f03df911b3e1c")}
      ...
      <Field label={tf("text.Instructions")} hint="Optional stable Hermes instructions sent separately from the wake input.">
        <DraftTextarea
          value={instructions}
