...
export function Companies() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: tf("text.Organizations") }]);
  }, [setBreadcrumbs]);
      ...
      <div className="flex items-center justify-end">
        {isCloud ? null : (
          <Button size="sm" onClick={() => openOnboarding()}>
            ...
            {tf("text.New Organization")}
          </Button>
        )}
      </div>

      <div className="h-6">
        {loading && <p className="text-sm text-muted-foreground">{tf("auto.a47e333dbd2e36a2")}</p>}
                ...
                <div className="flex items-center gap-1.5 tabular-nums">
                  ...
                  <span>
                    ...
                    {company.budgetMonthlyCents > 0
                      ...
                      : <span className="text-xs ml-1">{tf("auto.3c7719943f33a6ed")}</span>}
                  </span>
                </div>
