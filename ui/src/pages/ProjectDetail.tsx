    ...
    >
      <PopoverTrigger asChild>
        <button
          ...
          aria-label={tf("auto.c84c79faedf49229")}
        >
      ...
      <PopoverContent className="w-72 p-3" align="start">
        {/* Icon search + grid */}
        <p className="text-xs font-medium text-muted-foreground mb-2">{tf("auto.a35abcd6dac9a2e5")}</p>
        <Input
        ...
        <div className="mt-3 border-t border-border pt-3">
          <p className="text-xs font-medium text-muted-foreground mb-2">{tf("auto.6b73191a0a4b6742")}</p>
          <div className="grid grid-cols-5 gap-1.5">
            ...
            <button
              ...
              aria-label={tf("auto.e84dcf574b66184a")}
              title={tf("auto.be8c000445c13297")}
            >
  ...
  return (
    <div className="space-y-6">
      {showLeftProjectNotice ? (
        <div className="flex items-center gap-3 border border-yellow-300/35 bg-yellow-300/10 px-3 py-2 text-sm text-yellow-900 dark:text-yellow-100">
          ...
          <button
            ...
            aria-label={tf("auto.8aa3b27e2396253e")}
      ...
      <SummarySlotCard
        ...
        scopeKind="project"
        scopeId={project.id}
        title={tf("auto.34c863b318b5fff4")}
        description={tf("auto.6420c7957e8e8396")}
      />
      ...
      <Tabs value={activeTab ?? "list"} onValueChange={(value) => handleTabChange(value as ProjectTab)}>
        <PageTabBar
          items={[
            { value: "list", label: tf("text.Tasks") },

            ...(project.managedByPlugin ? [{ value: "plugin-operations", label: tf("auto.5d078940e3010691") }] : []),
            ...(showWorkspacesTab ? [{ value: "workspaces", label: tf("text.Workspaces") }] : []),
      ...
      {activeTab === "workspaces" ? (
        workspaceTabDecisionLoaded ? (
          ...
          <p className="text-sm text-muted-foreground">{tf("auto.3f9adb0f75f8f080")}</p>
        )
      ) : null}
