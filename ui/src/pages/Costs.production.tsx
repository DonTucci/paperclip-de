...
export function Costs() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: tf("text.Costs") }]);
  }, [setBreadcrumbs]);
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={DollarSign} message={tf("auto.88df4cd950bb862d")} />;
  }
    ...
    <div className="space-y-6">
      ...
      <Tabs value={mainTab} onValueChange={(value) => setMainTab(value as typeof mainTab)}>
        <TabsList variant="line" className="justify-start">
          ...
          <TabsTrigger value="budgets">{tf("auto.a1a06e046b0b9ad3")}</TabsTrigger>
