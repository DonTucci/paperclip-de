        ...
        <div className="flex shrink-0 items-center gap-1">
          {contentQuery.data ? (
            <Button
              ...
              variant="ghost"
              size="icon-sm"
              aria-label={tf("auto.b3278e5f53cc34b0")}
              title={copied ? tf("text.Copied") : tf("auto.b3278e5f53cc34b0")}
              onClick={() => {
          ...
          {downloadUrl ? (
            <Button asChild variant="ghost" size="icon-sm">
              <a href={downloadUrl} download={resource?.title} aria-label={tf("auto.9de4149fb9716cfc")} title={tf("auto.9de4149fb9716cfc")}>
