  ...
  switch (id) {
    case "session-start":
      return {
        surface: "thread",
        items: [
          { id: "mk-start", kind: "marker", variant: "session_start", label: tf("auto.a6a7c4b6edfc68a2"), detail: "claude · Auto mode" },
          ...exchangePrefix(),
        ],
      };
    case "human-message":
      ...
      return {
        ...
        items: [
          ...exchangePrefix(),
          {
            ...
            liveStatus: { id: "st-thinking", kind: "status", status: "running", label: tf("auto.a20d12c5e9c428c3"), startedAtMs: Date.now() - 6100, tokens: { used: 18240, size: 200000 } },
            items: [
      ...
      return {
        ...
        items: [
          ...exchangePrefix(),
          {
            ...
            summary: { toolCount: 1, added: 0, removed: 0 },
            liveStatus: {
              id: "st-responding", kind: "status", status: "running", label: tf("auto.98047c1e6a79f788"), startedAtMs: Date.now() - 9300, tokens: { used: 18240, size: 200000 },
              selfTalk:
      ...
      return {
        ...
        items: [
          ...exchangePrefix(),
          {
            ...
            liveStatus: {
              id: "st-responding-burst", kind: "status", status: "running", label: tf("auto.98047c1e6a79f788"), startedAtMs: Date.now() - 21400, tokens: { used: 18240, size: 200000 },
              selfTalk:
      ...
      return {
        ...
        items: [
          ...exchangePrefix(),
          {
            ...
            settled: false,
            summary: { toolCount: 2, added: 0, removed: 0 },
            liveStatus: { id: "st-working", kind: "status", status: "working", label: tf("auto.d868fdd01755f295"), detail: "Edit · server/src/routes/auth.ts", toolName: "Edit", startedAtMs: Date.now() - 4200 },
            items: [
      ...
      return {
        ...
        items: [
          ...exchangePrefix(),
          {
            ...
            settled: false,
            summary: { toolCount: 1, added: 0, removed: 0 },
            liveStatus: { id: "st-running", kind: "status", status: "running", label: tf("text.Running"), detail: "no output for 3s — still running", startedAtMs: Date.now() - 12000, tokens: { used: 18240, size: 200000 } },
            items: [
    ...
    case "awaiting-approval":
      return {
        ...
        items: [
          {
            id: "st-approval", kind: "status", status: "awaiting_approval", label: tf("auto.7347bea3a493944e"),
            detail: "npm run migrate — modifies the database",
            approval: {
              toolName: "execute",
              options: [
                { id: "reject", label: tf("auto.05a2d7332eb9d8bf"), kind: "reject_once" },
                { id: "allow-always", label: tf("auto.977618bd8bc7eef4"), kind: "allow_always" },
                { id: "allow", label: tf("auto.168511d24d9ee031"), kind: "allow_once" },
              ],
            },
          },
        ],
      ...
      return {
        ...
        items: [
          ...exchangePrefix(),
          {
            ...
            liveStatus: { id: "long-status", kind: "status", status: "working", label: tf("auto.6effe77ed6628990"), detail: "Bash · vitest", toolName: "Bash", startedAtMs: Date.now() - 48_000 },
            items: [
    ...
    case "interrupted":
      return {
        ...
        items: [
          ...
          { id: "mk-int", kind: "marker", variant: "interrupted", label: tf("auto.132d124d6bb3d811"), detail: "stopped by you at 2:35 PM" },
        ],
      };
    case "refused":
      return {
        surface: "thread",
        items: [
          { id: "st-refused", kind: "status", status: "refused", label: tf("auto.fb399aa0c2e8513a"), detail: "The agent declined to complete this request." },
        ],
      };
    case "truncated":
      return {
        surface: "thread",
        items: [
          { id: "st-trunc", kind: "status", status: "truncated", label: tf("auto.216e33437b793599"), detail: "Output was cut off — continue to resume.", tokens: { used: 199120, size: 200000 } },
        ],
      };
