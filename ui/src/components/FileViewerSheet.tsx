...
function normalizeError(error: unknown): FileViewerErrorShape {
  ...
  return { status: 0, code: "", message: tf("auto.0c953ab32c603ec4") };
}
...
export function describeDenial(code: string, fallback: string): { title: string; body: string; icon: ReactNode } {
  ...
  if (lower.includes("policy") || lower.includes("denied") || lower.includes("sensitive")) {
    return {
      ...
      title: tf("auto.2d9ad26c04e28f70"),
  ...
  if (lower.includes("outside") || lower.includes("traversal")) {
    return {
      ...
      title: tf("auto.aa3ce27795fd7967"),
  ...
  if (lower.includes("too_large") || lower.includes("size")) {
    return {
      icon: <AlertTriangle aria-hidden="true" className="h-6 w-6 text-amber-500" />,
      title: tf("auto.af94fcfb32e664dd"),
  ...
  return (
    <div className="flex min-h-(--sz-18px) flex-wrap items-center gap-x-2 gap-y-0.5 text-xs text-muted-foreground">
      {resolvedResource ? (
        ...
        <span className="h-3 w-28 rounded bg-muted animate-pulse" aria-label={tf("auto.768d734af4794369")} />
      ) : null}
    </div>
  );
}
  ...
  if (resource.previewKind === "image") {
    ...
    if (!dataUrl) {
      return (
        <FileViewerStateView
          icon={<AlertTriangle aria-hidden="true" className="h-6 w-6 text-amber-500" />}
          title={tf("auto.637262a20bd52f66")}
        />
      );
    }
    return (
  ...
  if (resource.previewKind === "video") {
    ...
    if (!dataUrl) {
      return (
        <FileViewerStateView
          icon={<AlertTriangle aria-hidden="true" className="h-6 w-6 text-amber-500" />}
          title={tf("auto.ba6b8bccdba03d34")}
        />
      );
    }
    return (
  ...
  return (
    <div className="relative flex min-h-0 flex-1 flex-col">
      <div className="absolute right-3 top-3 z-20">
        <div
          role="group"
          aria-label={tf("auto.7d6f9f68445c8539")}
        ...
        >
          <Button
            ...
            size="icon-sm"
            aria-label={tf("auto.a2755a357860567a")}
            title={tf("auto.021ce6464fdbd9ab")}
          ...
          <Button
            ...
            size="icon-sm"
            aria-label={tf("auto.399bc52a75485dab")}
            title={tf("auto.f41bae51b2f2f711")}
  ...
  if (elapsedMs < 400) {
    return (
      <div className="flex-1 space-y-2 p-6" aria-busy="true" aria-live="polite">
        <span className="sr-only">{tf("auto.7b144afcb8ba28ac")}</span>
            ...
            <div className="flex shrink-0 items-center gap-1 self-start">
              ...
              {cameFromBrowse ? (
                <Button
                  ...
                  aria-label={tf("auto.f911e3dbe7ed1720")}
                >
                  <ArrowLeft className="h-3.5 w-3.5" />
                  {tf("auto.f911e3dbe7ed1720")}
                </Button>
              ) : null}
              {state ? (
                downloadUrl ? (
                  ...
                  >
                    <a
                      ...
                      aria-label={tf("auto.9de4149fb9716cfc")}
                      title={tf("auto.9de4149fb9716cfc")}
                    >
              ...
              {state ? (
                <Button
                  ...
                  aria-label={copiedField === "content" ? tf("auto.b4dbbc32c9e0f03d") : tf("auto.b3278e5f53cc34b0")}
                  title={copiedField === "content" ? tf("auto.6604ead1f5fb5265") : tf("auto.b3278e5f53cc34b0")}
                  className="h-7 w-7"
                >
              ...
              {state ? (
                <Button
                  ...
                  aria-label={copiedField === "link" ? tf("auto.b2acd5751d8a9697") : tf("auto.ed399e88a77e9916")}
                  title={copiedField === "link" ? tf("auto.933540542c9dcebf") : tf("text.Copy link")}
                  className="h-7 w-7"
                >
                  {copyingField === "link" ? (
                    <Loader2 className="h-4 w-4 animate-spin" />
              ...
              <Button
                ...
                className="h-7 w-7"
                aria-label={tf("auto.ca47c733c6d0598c")}
                title={tf("text.Close")}
              >
                <X className="h-4 w-4" />
              </Button>
          ...
          {state ? (
            <div className="flex min-h-0 flex-1 gap-3 bg-muted/30 p-3">
              ...
              <div
                ...
                aria-label={tf("auto.8c62ea073f353cd6")}
  ...
  if (resolveQuery.isError) {
    ...
    if (normalized.status === 404) {
      return (
        <FileViewerStateView
          ...
          title={tf("auto.3521021a2e875fbc")}
    ...
    if (normalized.status === 422) {
      return (
        <FileViewerStateView
          icon={<FolderOpen aria-hidden="true" className="h-6 w-6 text-muted-foreground" />}
          title={tf("auto.8621cdb8240db314")}
  ...
  if (resource.kind === "remote_resource") {
    return (
      <FileViewerStateView
        ...
        title={tf("auto.e823cbb5ec17da94")}
