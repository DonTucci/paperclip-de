...
export function BlockedInboxView({
  ...
  if (error) {
    const message =
      error instanceof Error ? error.message: tf("auto.a61e4428eceeaed4");
    return (
      <div
      ...
      >
        <div className="flex items-start gap-2">
          ...
          <div className="flex-1 space-y-1">
            <p className="text-sm font-medium">{tf("auto.a61e4428eceeaed4")}</p>
    ...
    return (
      ...
      >
        ...
        <div className="space-y-1">
          <p className="text-sm font-medium text-foreground">{tf("auto.6d4397f7dcd7c4aa")}</p>
          <p className="text-xs text-muted-foreground">
            {tf("auto.ec0fc599cc6de16c")}
          </p>
        </div>
      </Card>
    );
