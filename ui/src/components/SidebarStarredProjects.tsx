...
export function SidebarStarredProjects() {
  ...
  return (
    <div className="flex flex-col gap-0.5" aria-label={tf("auto.2212799bd8ac8377")}>
        ...
        const link = (
          ...
          >
            ...
            {!rail && project.pauseReason === "budget" ? (
              <BudgetSidebarMarker title={tf("auto.1aa2562895efb503")} />
            ) : null}
          </NavLink>
        );
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-48">
                  ...
                  >
                    ...
                    <span>{tf("auto.f1133f6566cd1093")}</span>
                  </DropdownMenuItem>
                  <DropdownMenuSeparator />
                  <DropdownMenuItem
                    onClick={() => {
                  ...
                  >
                    ...
                    <span>{tf("auto.4c6941ff7aa37c0c")}</span>
                  </DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
            ) : null}
