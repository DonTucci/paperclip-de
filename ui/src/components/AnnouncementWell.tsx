...
export function AnnouncementWell({ health }: { health?: HealthStatus }) {
  ...
  return (
    <aside aria-label={tf("auto.0f9b3c822bcb0356")} className="announcement-well fixed left-3 bottom-(--announcement-mobile-bottom) z-40 w-(--announcement-available-width) max-w-(--announcement-width) max-h-(--announcement-mobile-max-height) overflow-y-auto md:bottom-3 md:max-h-(--announcement-max-height)">
